...
export const coreBenefitsData: CoreBenefitType[] = [
  {
    ...
    description:
      "Moonboard equips developers with the latest tools to rapidly build scalable, modern dashboards with less friction.",
    points: [
  ...
  },
  {
    ...
    description:
      "With customizable themes and built-in accessibility, Moonboard adapts seamlessly to your team’s needs and user diversity.",
    points: [
  ...
  },
  {
    ...
    description:
      "Moonboard includes essential, production-ready features like authentication, form validation, and rich data components.",
    points: [
